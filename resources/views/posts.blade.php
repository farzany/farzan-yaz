...
@section('content')
    <div class="posts">
        ...
        <div class="newsletter py-12 mt-12 flex justify-center items-center border-y border-db">
            ...
            <div class="subscribe text-center flex flex-col items-center h-full w-fit max-w-full pr-4">
                <h2 class="text-2xl">Subscribe to get notified about new posts!</h2>
                <p class="font-work text-lg pb-3 pt-1">I'll keep it clean, I promise - only one a week.</p>
